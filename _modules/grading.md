...
30%
: <span style="color: #D97706;">**Assignments**</span> <br> Short homeworks on lecture days, including problem sets and <br> conceptual questions. 
  : <br> 6 total

30%
: <span style="color: #D97706;">**Guided Projects**</span>  <br> Guided python notebooks that apply lecture topics to real-world <br> biological datasets. Will be primarily completed in-class, with  <br> opportunities for collaboration. 
  : <br>  4 total
