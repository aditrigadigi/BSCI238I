...
<span style="display: block; margin-top: 18px; color: #543290;"><strong>Th 3:30 PM -4:20 PM @ ESJ B0322</strong>  |  <strong>Fall 2026</strong>  |  <strong>1 Credit</strong></span>



Machine learning is transforming the life sciences, enabling breakthroughs in fields such as genomics, medical imaging, and drug discovery. This course introduces students to the fundamental principles of machine learning and its applications in biology and medicine. 

Students will learn about key machine learning techniques, including  <span style="color: #543290;">classification</span>,  <span style="color: #543290;">regression</span>,  <span style="color: #543290;">clustering</span>, and  <span style="color: #543290;">deep learning</span>, with a focus on practical applications like  <span style="color: #D97706;">cancer diagnosis</span>,  <span style="color: #D97706;">gene expression analysis</span>, and  <span style="color: #D97706;">protein structure prediction</span>. 

Through lectures and guided projects, students will gain an understanding of how to apply machine learning models to biological datasets, evaluate their performance, and interpret results. **No prior programming or machine learning experience is required**—this course is designed to bridge the gap between computational techniques and life science research, preparing biology students to understand and leverage machine learning as a tool as they encounter real-world challenges in their fields of study.
